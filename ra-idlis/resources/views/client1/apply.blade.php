				...
				<div class="col-md-5">
					<div class="media blog-thumb">
						...
						<div class="media-body blog-info">
							...
							<h3><a style="color: #252525;font-weight: normal;transition: 0.5s; text-decoration: none !important;" href="{{asset('/client1/messages')}}"> History Records</a></h3>
							<p>History Records of your Previous Applications</p>
							<div class="text-center">                                   	
								<a href="{{asset('/client1/messages')}}" class="btn section-btn">View Records</a>
							</div>
						</div>
					</div>
				</div>
