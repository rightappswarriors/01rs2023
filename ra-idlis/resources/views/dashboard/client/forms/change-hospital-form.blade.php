                                ...
                                @foreach ($mainservices_reg as $d)
                                    <tr>
                                        ...
                                        @if($isupdate == 1)   
                                            ...
                                            )" data-toggle="modal" data-target="#mainService"><i class="fa fa-edit"></i></button></td>
                                        @endif 
                                    </tr>
                                @endforeach	
                            @else
                            ...
                            <select name="facid" id="ms_facid" class="form-control select2-hidden-accessible" style="width: 100%" data-select2-id="ms_facid" tabindex="-1" aria-hidden="true">
                                ...
                                @if (isset($mainservicelist))
                                    @foreach ($mainservicelist as $d)
                                        <option value="{{$d->facid}}">[{{$d->facid}}] {{$d->facname}}</option>
                                    @endforeach	
                                @endif
                ...
                <div class="container">
                    <form id="frmAddOnService" action="{{asset('/client1/changerequest/actionsubmit')}}" method="POST">
                        ...
                        @if($isupdate)
                            ...
                            <div class="col-sm-8" style="margin:0 0 .8em 0;">
                                <select name="facid_old" id="ao_facid_current" class="form-control select2-hidden-accessible" style="width: 100%:" data-select2-id="ao_facid" tabindex="-1" aria-hidden="true" disabled="disabled">
                                    <option value="" disabled="" readonly="" hidden="" selected="" data-select2-id="2">Please Select</option>
                                    @if (isset($addonservicelist))
                                        @foreach ($addonservicelist as $d)
                                            <option value="{{$d->facid}}">[{{$d->anc_name}}][{{$d->facid}}] {{$d->facname}}</option>
                                        @endforeach	
                                    @endif
                                </select>
                            </div>	
                        ...
                        <div class="col-sm-8" style="margin:0 0 .8em 0;">
                            <select name="facid" id="ao_facid" class="form-control select2-hidden-accessible" style="width: 100%:" data-select2-id="ao_facid" tabindex="-1" aria-hidden="true">
                                <option value="" disabled="" readonly="" hidden="" selected="" data-select2-id="2">Please Select</option>
                                @if (isset($addonservicelist))
                                    @foreach ($addonservicelist as $d)
                                            <option value="{{$d->facid}}">[{{$d->anc_name}}][{{$d->facid}}] {{$d->facname}}</option>
                        ...
                        <div class="col-sm-8" style="margin:0 0 .8em 0;">
                            <input type="text" name="servowner" id="ao_servowner" data-parsley-required-message="*<strong>Part Code</strong> required" class="form-control" required="">
                        </div>	
                        <br/>
                        <div class="col-sm-4"></div>
                        <div class="col-sm-12">
